...
class ProjectsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Projects entity")
        ...
        .repeat(2) {
            ...
            .post("/api/projects")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "startDate":"2020-01-01T00:00:00.000Z", "endDate":"2020-01-01T00:00:00.000Z", "estimatedEndDate":"2020-01-01T00:00:00.000Z", "status":null}""")).asJSON
            .check(status.is(201))
