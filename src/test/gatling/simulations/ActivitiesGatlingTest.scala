...
/**
 * Performance test for the Activities entity.
 */
class ActivitiesGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Activities entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created activities")
                .get("${new_activities_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created activities")
            .delete("${new_activities_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
